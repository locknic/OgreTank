...
OgrePong::createCamera()
{
	...
	mCamera2 = mSceneMgr->createCamera("ComputerCam");
...
OgrePong::createViewports(void)
{
        ...
        Ogre::Viewport* vp = mWindow->addViewport(mCamera,1,0,0,0.5,1);
        vp->setBackgroundColour(Ogre::ColourValue(1,1,1));
        // Alter the camera aspect ratio to match the viewport
        mCamera->setAspectRatio(Ogre::Real(vp->getActualWidth()) / Ogre::Real(vp->getActualHeight()));    

		Ogre::Viewport* vp2 = mWindow->addViewport(mCamera2,2,0.5,0,0.5,1);
...
OgrePong::createScene() 
{
    ...
    mPongCamera = new PongCamera(mCamera, mCamera2, mWorld);
